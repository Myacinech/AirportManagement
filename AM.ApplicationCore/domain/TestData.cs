...
namespace AM.ApplicationCore.domain
{
...

    {
        ...
        public static Planes BoingPlane = new Planes { PlaneType = PlaneType.Boing, Capacity = 150, ManufactureDate = new DateTime(2015, 02, 03) };

        public static Planes Airbusplane = new Planes { PlaneType = PlaneType.Airbus, Capacity = 250, ManufactureDate = new DateTime(2020, 11, 11) };
